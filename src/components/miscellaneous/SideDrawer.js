...
const SideDrawer = () => {
  ...
  const handleNews = async () => {
    try {
      ...
      const { data } = await axios.get(
        ENDPOINT + `/api/news?search=${newsCategory}`,
        config
      );
                  ...
                  >
                      ...
                      {newsResult?.map((news) => (
                        ...
                        >
                          <div style={{ fontSize: "20px", fontWeight: "900" }}>
                            {translateFlag ? news.Topic : news.Thai_Topic}
                          </div>
                          ...
                          >
                            {translateFlag ? news.Detail : news.Thai_Detail}
                          </div>
                        </Box>
                      ))}
                    </div>
                    ...
                    >
                      {newsItem == null ? (
                        ...
                        >
                          <div>Select News on the left to read!</div>
                        </div>
                      ) : (
                        <div
                          style={{
                        ...
                        >
                          ...
                          <div style={{ fontSize: "15px", fontWeight: "bold" }}>
                            Category: {newsItem?.Category.replace("$", "")}
                          </div>
                          <div style={{ fontSize: "15px", fontWeight: "bold" }}>
                            {newsItem?.Date}
                          </div>
                          ...
                          <div>
                            {translateFlag
                              ? newsItem?.Detail
                              : newsItem?.Thai_Detail}
                          </div>
                          <a
                            href={newsItem?.Full_Link}
                            style={{ color: "blue" }}
                          >
                            <br></br>Source: {newsItem?.Full_Link}
                          </a>
                        </div>
                      )}
                    </div>
            ...
            <ModalContent pl={5} pr={5} pt={5}>
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    onClick={function () {
                      onOpenNewsItems();
                      setNewsCategory("");
                      setNewsCategoryHeader("All News");
                    }}
                  ></div>
                </div>
                {/* Flex 2 */}
                <div
                  ...
                  onClick={function () {
                    onOpenNewsItems();
                    setNewsCategory("zero");
                    setNewsCategoryHeader("Zero Day Attack");
                  }}
                >
                  <div
                    id="zero-day"
                  ...
                  <div
                    ...
                    onClick={function () {
                      onOpenNewsItems();
                      setNewsCategory("hack");
                      setNewsCategoryHeader(
                ...
                >
                  <div
                    ...
                    onClick={function () {
                      ...
                      setNewsCategoryHeader("Data Security");
                    }}
                  ></div>
                  <div
                    id="vulnerbility"
                    ...
                    onClick={function () {
                      onOpenNewsItems();
                      setNewsCategory("vulner");
                      setNewsCategoryHeader("Vulnerbility Likelihood");
                    }}
                  ></div>
                </div>
              </ModalBody>
