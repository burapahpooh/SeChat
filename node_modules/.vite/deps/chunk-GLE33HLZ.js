...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react4.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react5.useRef)(modifiers);
  const popperInstanceRef = (0, import_react5.useRef)();
  ...
  const [popperState, setState] = useSafeState_default((0, import_react5.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react5.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react5.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react6.useRef)(false);
  const waitingForTrigger = (0, import_react6.useRef)(false);
  const handleMouseCapture = (0, import_react6.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context3 = (0, import_react7.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react7.useRef)(false);
  const {
    flip: flip2,
    offset: offset2,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react8.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react8.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react8.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react8.useState)(true);
  ...
  return (0, import_react8.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react8.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react8.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react8.default).createElement((0, import_react8.default).Fragment, null, props.children);
  }
  return (0, import_react8.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react8.useContext)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, import_react8.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react8.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react8.default).useId();
  let [didSSR] = (0, import_react8.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react8.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react8.default)["useSyncExternalStore"] === "function")
    return (0, import_react8.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react8.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react9.useContext)(DropdownContext_default) || {};
...
function useDropdownItem({
  ...
  const navContext = (0, import_react10.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react11.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react11.useRef)(null);
  const focusInDropdown = (0, import_react11.useRef)(false);
  const onSelectCtx = (0, import_react11.useContext)(SelectableContext_default);
  const toggle = (0, import_react11.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  useEventListener((0, import_react11.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  var wasPropRef = (0, import_react12.useRef)(propValue !== void 0);
  var _useState = (0, import_react12.useState)(defaultValue), stateValue = _useState[0], setState = _useState[1];
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react12.useCallback)(function(value) {
...
var context2 = React17.createContext(null);
...
var DropdownMenu2 = React18.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
...
var DropdownToggle2 = React20.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
...
var Dropdown2 = React21.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
  ...
  return (0, import_jsx_runtime16.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime16.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime16.jsx)(Component, {
        ...props,
        ref,
...
//# sourceMappingURL=chunk-GLE33HLZ.js.map
